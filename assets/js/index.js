...
const prioridades = ['0', 'baixa', 'media', 'alta']
...
const onDeleteClick = (evt) => {
    // Capturando id da tarefa a ser repetida
...
/**
 * Criar função destroy que recebe o id de uma tarefa como parâmetro e remove essa letra do array
 */
